...
\begin{enumerate}
  ...
  \item HW \#1 due Friday (hard copy beginning of class)
\end{enumerate}
...
\begin{enumerate}
  ...
  \item Open this \href{https://docs.google.com/spreadsheet/ccc?key=0AlS2-t0MMCgvdDhBLTQ5cHNyTzJEc1lYMVd0ckJ4c2c&usp=sharing}{Google Spreadsheet}, and start entering data. 
